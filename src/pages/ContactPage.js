        ...
        <div className="contactPage">
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={"+27 78 678 8778"} text2={"+27 69 488 2450"} title={"Phone"}/>
                    <ContactItem icon={email} text1={"edgarmurudu@gmail.com"} text2={"edgarmurudu@gmail.com"} title={"Email"}/>
                     <ContactItem icon={location} text1={"26 Dartford Drive"} text2={"Parklands Cape Town 7744"} title={"Address"}/>
